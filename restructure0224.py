...
## Printing options
def print_out(final_dict, patient):
    print(
    ...
    if op2 == 'Y':
        ...
        # call print_function here
        plot_dat(final_dat, patient)
...
if __name__ == '__main__':
    ...
    ## add safeguard loop for no file found

    if contents != 'end':
        # If file present, then tuple unpacked
        (hdr, csv) = contents
